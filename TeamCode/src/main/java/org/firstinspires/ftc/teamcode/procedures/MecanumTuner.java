...
public class MecanumTuner extends Procedure {
    ...
    public void run() throws InterruptedException {
        ...
        Direction frontLeftDirection =
                testMotor(Wheel.FRONT_LEFT, "Front Left", frontLeftName.get());
        ...
        Direction backRightDirection =
                testMotor(Wheel.BACK_RIGHT, "Back Right", backRightName.get());
        ...
        withDisplay(
                ...
                () -> {
                    ...
                    Inputs.Field<Boolean> correctMotorField =
                            inputs.b("Did the " + displayName.toLowerCase() + " motor spin?")
                                    .withDefault(true);
